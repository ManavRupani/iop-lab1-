...
user_d = int(input("Enter the number of dimes: "))          #taking input
user_q = int(input("Enter the number of quarters: "))

PENNY_VALUE = 1
NICKEL_VALUE = 5
DIME_VALUE = 10                                             #global variable
QUARTER_VALUE = 25
PENNIES_IN_DOLLAR = 100
...
if total_dollars==1:
    ...
    print("Sorry, the amount you entered was less than one dollar.")    #operation
elif total_dollars > 1.0:
